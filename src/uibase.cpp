...
CMainFrameBase::CMainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText41 = new wxStaticText( this, wxID_ANY, _("Balance:"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	m_staticText41->Wrap( -1 );
	wxFont font(20, wxFONTFAMILY_TELETYPE, wxNORMAL, wxNORMAL);
    m_staticText41->SetFont(font);
	...
	m_staticTextBalance->SetFont(font);
    ...
    m_toolBar = new wxToolBar(this, wxID_ANY ,wxDefaultPosition,wxDefaultSize,wxTB_TEXT|wxTB_HORZ_LAYOUT|wxTB_VERTICAL |wxTB_FLAT );
	m_toolBar->SetToolBitmapSize( wxSize( 20,20 ) );
	m_toolBar->SetToolSeparation( 1 );
	m_toolBar->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 90, false, wxEmptyString ) );

	m_toolBar->AddTool( wxID_BUTTONSEND, _("Send SolidCoins"), wxBitmap( send20_xpm ), wxNullBitmap, wxITEM_NORMAL, wxEmptyString, wxEmptyString );
    ...
    bSizer2->Add(pGrid,0,wxEXPAND,5);
	...
	m_listCtrlAll->SetBackgroundColour(wxColour(64,64,64));
...
CSendDialogBase::CSendDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticTextInstructions = new wxStaticText( this, wxID_ANY, _("Enter a SolidCoin address (e.g. sNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)\nThere is a set fee of 0.01 SC for sending"), wxDefaultPosition, wxDefaultSize, 0 );
...
CYourAddressDialogBase::CYourAddressDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText45 = new wxStaticText( this, wxID_ANY, _("These are your SolidCoin addresses for receiving payments.  You may want to give a different one to each sender so you can keep track of who is paying you.  The highlighted address is displayed in the main window."), wxDefaultPosition, wxDefaultSize, 0 );
